...
Connecting host settings: Set the Wifi (through Netgear) using address "192.168.2.x" (x could be any number from 2 to 254 except 22) with netmask **24**. The gateway is also set to "192.168.2.1".
